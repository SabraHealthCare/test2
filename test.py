...
def Initial_Mapping(operator):
    ...
    account_mapping['Sabra_Account'] = account_mapping['Sabra_Account'].apply(lambda x: x.upper() if (x is not None) and pd.notna(x) else x)
    account_mapping['Sabra_Second_Account'] = account_mapping['Sabra_Second_Account'].apply(lambda x:  x.upper() if (x is not None) and pd.notna(x) else x)
...
def Map_PL_Sabra(PL,entity):
    ...
    second_account_mapping=account_mapping[account_mapping["Sabra_Second_Account"]!=" " ]
    second_account_mapping=second_account_mapping["Sabra_Second_Account"].apply(lambda x:x.strip() if (x is not None) & ( pd.notna(x)) else x)
    second_account_mapping=second_account_mapping["Sabra_Second_Account"].apply(lambda x:len(x))
    second_account_mapping=second_account_mapping.dropna(subset="Sabra_Second_Account")
    ...
    st.write("second_account_mapping--3",second_account_mapping)
