...
def View_Summary():
    ...
    st.write(BPC_pull)
    st.write(list(BPC_Account[BPC_Account["Category"]=="Facility Information"]["BPC_Account_Name"]))
    previous_facility_data=BPC_pull[(BPC_pull["Property_Name"].isin(properties_missing_facility))&(BPC_pull["ACCOUNT"].isin(list(BPC_Account[BPC_Account["Category"]=="Facility Information"]["BPC_Account_Name"])))][onemonth_before_latest_month]
