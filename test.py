...
def Initial_Mapping(operator):
    ...
    account_mapping['Sabra_Account'] = account_mapping['Sabra_Account'].apply(lambda x: x.capitalize() if pd.notna(x) else x)
    account_mapping['Sabra_Second_Account'] = account_mapping['Sabra_Second_Account'].apply(lambda x: x.capitalize() if pd.notna(x) else x)
