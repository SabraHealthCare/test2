...
def View_Summary():
    ...
    previous_facility_data=BPC_pull[BPC_pull["Property_Name"].isin(properties_missing_facility)][BPC_pull["ACCOUNT"].isin(facility_account_list)][onemonth_before_latest_month]
